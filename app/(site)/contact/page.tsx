...
const ContactSection = () => {
  ...
  return (
    <div className="flex flex-col gap-8 w-full items-center justify-center bg-(--color-neutral-1) mx-auto px-4 sm:px-6 lg:px-8 md:pb-5 md:pt-40 pt-40">
            ...
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-(--color-primary) hover:bg-[#d14334] text-white font-semibold py-3 rounded-lg transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
