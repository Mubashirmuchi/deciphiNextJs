  ...
  return (
    <div className="relative space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-3  border-2 bg-(--color-neutral-3) border-gray-100 rounded-lg p-6 sm:p-8">
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4">
              <div className="flex justify-between items-start pb-6 border-b-2 border-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {/* System Integration */}
        <div className="bg-(--color-neutral-3) border-2 border-gray-100 rounded-lg p-6">
        ...
        {/* Cloud Security */}
        <div className="bg-(--color-neutral-3) border-2 border-gray-100 rounded-lg p-6 md:col-span-2 lg:col-span-1">
          <div className="space-y-6 h-full flex flex-col">
            <div className="space-y-4">
              <div className="flex justify-between items-start pb-6 border-b-2 border-gray-100">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-rethink font-medium text-text-secondary1 flex-1 pr-4">
